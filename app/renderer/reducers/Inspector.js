...
import { SET_SOURCE_AND_SCREENSHOT, QUIT_SESSION_REQUESTED, QUIT_SESSION_DONE,
  ...
  SHOW_LOCATOR_TEST_MODAL, HIDE_LOCATOR_TEST_MODAL, SHOW_PERFORM_ACTION_MODAL, HIDE_PERFORM_ACTION_MODAL,
  SET_LOCATOR_TEST_STRATEGY, SET_LOCATOR_TEST_VALUE,
...
const INITIAL_STATE = {
  ...
  isPerformActionModalVisible: false,
...
export default function inspector (state=INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case SHOW_PERFORM_ACTION_MODAL:
      return {
        ...state,
        isPerformActionModalVisible: true,
      };

    case HIDE_PERFORM_ACTION_MODAL:
      return {
        ...state,
        isPerformActionModalVisible: false,
      };
